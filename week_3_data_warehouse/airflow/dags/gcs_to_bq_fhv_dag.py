...
with DAG(
    ...
    gcs_to_gcs = GCSToGCSOperator(
        task_id="fhv_gcs_to_gcs_task",
        source_bucket=BUCKET,
        source_objects=['raw/fhv_tripdata/2019/*.parquet', 'raw/fhv_tripdata/2020/*.parquet',
                        'raw/fhv_tripdata/2021/*.parquet'],
        destination_bucket=BUCKET,
        delimiter='.parquet',
        move_object=True,
        destination_object='fhv_tripdata_all/',
    )
    ...
    gcs_to_bq_ext = BigQueryCreateExternalTableOperator(
        ...
        table_resource={
            "tableReference": {
                ...
                "tableId": "external_fhv_tripdata_all_table",
            },
            "externalDataConfiguration": {
                "sourceFormat": "PARQUET",
                "sourceUris": [f"gs://{BUCKET}/fhv_tripdata_all/*"],
            },
        },
    )
    ...
    CREATE_PART_TABLE_QUERY = f"CREATE OR REPLACE TABLE {BIGQUERY_DATASET}.fhv_tripdata_partitioned \
        ...
        SELECT * FROM {BIGQUERY_DATASET}.external_fhv_tripdata_all_table;"
