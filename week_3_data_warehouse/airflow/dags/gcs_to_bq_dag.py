...
with DAG(
    ...
    gcs_to_gcs = GCSToGCSOperator(
        ...
        source_objects=['raw/yellow_tripdata/2019/*.parquet', 'raw/yellow_tripdata/2020/*.parquet',
                        'raw/yellow_tripdata/2021/*.parquet'],
        destination_bucket=BUCKET,
        delimiter='.parquet',
        move_object=True,
        destination_object='yellow_tripdata_all/',
    )
    ...
    gcs_to_bq_ext = BigQueryCreateExternalTableOperator(
        ...
        table_resource={
            "tableReference": {
                ...
                "tableId": "external_yellow_tripdata_all_table",
            },
            "externalDataConfiguration": {
                "sourceFormat": "PARQUET",
                "sourceUris": [f"gs://{BUCKET}/yellow_tripdata_all/*"],
            },
        },
    )
    ...
    CREATE_PART_TABLE_QUERY = f"CREATE OR REPLACE TABLE {BIGQUERY_DATASET}.yellow_tripdata_partitioned \
        ...
        SELECT * FROM {BIGQUERY_DATASET}.external_yellow_tripdata_all_table;"
